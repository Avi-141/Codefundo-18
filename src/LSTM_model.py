"""Take the encoded image matrix, convert the time series problem into a
supervised learning and save the trained model"""
...
train_X, train_y = train[:, :1124], train[:, 1124:]
test_X, test_y = test[:, :1124], test[:, 1124:]
...
# design network
model = Sequential()
model.add(LSTM(100, input_shape=(1, train_X.shape[2])))
